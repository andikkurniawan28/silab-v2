...
<div class="modal fade bd-example-modal-xl" id="meja_2" tabindex="-1" sample="dialog" aria-labelledby="meja_2Label" aria-hidden="true">
    <div class="modal-dialog modal-xl" sample="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="meja_2Label">Meja Tebu 2</h5>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="barcode">
                            @foreach ($rafactions_unscored[2] as $rafaction_unscored)

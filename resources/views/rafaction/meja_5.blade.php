...
<div class="modal fade bd-example-modal-xl" id="meja_5" tabindex="-1" sample="dialog" aria-labelledby="meja_5Label" aria-hidden="true">
    <div class="modal-dialog modal-xl" sample="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="meja_5Label">Meja Tebu 5</h5>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="barcode">
                            @foreach ($rafactions_unscored[5] as $rafaction_unscored)

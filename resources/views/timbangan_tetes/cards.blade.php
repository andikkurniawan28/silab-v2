            ...
            <div class="table-responsive">
                <table width="100%" class="table table-sm table-hovered text-light text-left">
                    ...
                    <tr>
                        ...
                        <td>{{ number_format($data['bj_jam'][$i], 2) }}</td>
                    </tr>
                    @endfor
                </table>
            </div>

...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary">Data {{ ucfirst('Analisa Gula') }}</h5>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered text-dark table-hover text-sm" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $sugar->id }}</td>
                            <td>
                                <a href="#" data-toggle="modal" data-target="#show{{ $sugar->id }}">{{ $sugar->sample->material->name }}</a>
                            </td>
                            <td>{{ $sugar->sulphur }}</td>

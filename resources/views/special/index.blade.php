...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary">Data {{ ucfirst('Analisa Khusus') }}</h5>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered text-dark table-hover text-sm" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $special->id }}</td>
                            <td>
                                <a href="#" data-toggle="modal" data-target="#show{{ $special->id }}">{{ $special->sample->material->name }}</a>
                            </td>
                            <td>{{ $special->tsai }}</td>
        ...
        <div class="card-footer">
            ...
            <a href="specials_correction" type="button" class="btn btn-info">
                @include('components.icon', ['icon' => 'history '])
                Koreksi
            </a>

            @if(Auth()->user()->role_id == 1 or Auth()->user()->role_id == 2)
            <a href="specials_verification" type="button" class="btn btn-secondary">
